  ...
  actions: z.array(
    z.object({
      ...
      parameters: z.object({
        ...
        x: z.number().min(-30_000_000).max(30_000_000).optional(),
        z: z.number().min(-30_000_000).max(30_000_000).optional(),
        tolerance: z.number().min(0.5).max(64).optional(),
        timeoutMs: z.number().int().min(1000).max(600_000).optional(),
        pointerX: z.number().min(0).max(8192).optional(),
